...
const Footer = () => {
    ...
    const socialLinks = [
        {
            name: 'GitHub',
            url: getValue('github') || 'https://github.com/',
            icon: (
        ...
        {
            name: 'LinkedIn',
            url: getValue('linkedin') || 'https://linkedin.com/',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Email',
            url: `mailto:${getValue('email') || 'jkapa0417@gmail.com'}`,
            icon: (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-white/60 text-sm leading-relaxed">
                            ...
                            at LG Electronics. Building the future of cloud and AI.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <nav className="flex flex-col gap-2">
                            ...
                            <Link to="/projects" className="text-white/60 hover:text-white transition-colors text-sm">
                                Projects
                            </Link>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 text-center">
                    <p className="text-white/40 text-sm">
                        © {currentYear} Jun Ki Ahn. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
